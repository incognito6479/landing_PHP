...
<html lang="en">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-5 relative align-self-center">
            ...
            <form action="?page=start" method="post" class="bg-white rounded pb_form_v1">
              <h2 class="mb-4 mt-0 text-center">Sign Up for Free</h2>
              <div class="form-group">
                <input type="text" class="form-control pb_height-50 reverse" placeholder="Enter email..." required name="email" value="<?php if(isset($_SESSION['email']) && $_SESSION['email']){echo $_SESSION['email'];$_SESSION['email'] = '';}?>">
              </div>
              <div class="form-group">
                <input type="submit" class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue" value="SIGN UP">
                <input type="hidden" name="hook" value="SignUp">
              </div>
            </form>
    ...
    <?php
       if(isset($_SESSION['email_has']) && $_SESSION['email_has']) {
          echo '<script> setTimeout(function(){ alert("This email already used"); }, 1000); </script>';
          $_SESSION['email_has'] = '';
       }


       if(isset($_SESSION['success']) && $_SESSION['success']) {
          echo '<script> setTimeout(function(){ alert("You have signed up, please check your email"); }, 1000); </script>';
          $_SESSION['success'] = '';
       }
       ...
       if(isset($_SESSION['email_error']) && $_SESSION['email_error']) {
          ...
          foreach($errors as $error) {
             $show_error .= $error[0];
             echo '<script> setTimeout(function(){ alert("' . $show_error . '"); }, 1000); </script>';
          }
